...
const DamsResultChart = ({data}) => {
    ...
    const animatedText = useAnimatedProps(()=>{
        return{
            text: state.y.valor.value.value.toString() + "%",
            defaultValue: ""
        }
    })
    const animatedDateText = useAnimatedProps(()=>{
        return{
            text: state.x.value.value.toString() + " dias aptos consecutivos",
            defaultValue: ""
        }
    })
    ...
    return (
        <View style={{height: 400}}>
            ...
            <View style={{height: 100}}>
                ...
                <Text>
                    {data[0]['diasAptos']} dias aptos consecutivos
                </Text>
            </View>
            )}
...
export default DamsResultChart